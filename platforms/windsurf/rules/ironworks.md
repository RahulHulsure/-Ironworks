...
<!-- Platform adapter: Windsurf (.windsurf/rules/ironworks.md) -->
...
Scaffold from zero to production-ready. Detects stack (16+ supported: Next.js, React, Vue, Angular, SvelteKit, Express, FastAPI, Django, Laravel, Go, Rust, Java/Spring, Scala, Elixir/Phoenix, .NET, Flutter), creates Windsurf rules, CONTEXT.md, .env.example, ironworks/specs/, docs/adr/, CI config, git init.

**Variants:** `--stack <name>` (skip detection), `--minimal` (git + rules + .gitignore)
...
<!-- Install: Copy this file to .windsurf/rules/ironworks.md in your project root. -->
