...
<!-- Platform adapter: Gemini CLI (GEMINI.md at project root) -->
...
Scaffold from zero to production-ready. Detects stack (16+ supported: Next.js, React, Vue, Angular, SvelteKit, Express, FastAPI, Django, Laravel, Go, Rust, Java/Spring, Scala, Elixir/Phoenix, .NET, Flutter), creates GEMINI.md, CONTEXT.md, .env.example, ironworks/specs/, docs/adr/, CI config, git init.

**Variants:** `--stack <name>` (skip detection), `--minimal` (git + GEMINI.md + .gitignore)
...
<!-- Install: Copy this file to GEMINI.md in your project root. Gemini CLI loads it automatically. -->
