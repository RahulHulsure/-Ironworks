...
<!-- For multi-repo setups, place one copy per repository. -->
...
Scaffold from zero to production-ready. Detects stack (16+ supported: Next.js, React, Vue, Angular, SvelteKit, Express, FastAPI, Django, Laravel, Go, Rust, Java/Spring, Scala, Elixir/Phoenix, .NET, Flutter), creates copilot-instructions.md, CONTEXT.md, .env.example, ironworks/specs/, docs/adr/, CI config, git init.

**Variants:** `--stack <name>` (skip detection), `--minimal` (git + copilot-instructions.md + .gitignore)
...
<!-- Install: Copy this file to .github/copilot-instructions.md in your project root. -->
