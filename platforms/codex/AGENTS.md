...
<!-- Platform adapter: OpenAI Codex (AGENTS.md) -->
...
Scaffold from zero to production-ready. Detects stack (16+ supported: Next.js, React, Vue, Angular, SvelteKit, Express, FastAPI, Django, Laravel, Go, Rust, Java/Spring, Scala, Elixir/Phoenix, .NET, Flutter), creates AGENTS.md, CONTEXT.md, .env.example, ironworks/specs/, docs/adr/, CI config, git init.

**Variants:** `--stack <name>` (skip detection), `--minimal` (git + AGENTS.md + .gitignore)
