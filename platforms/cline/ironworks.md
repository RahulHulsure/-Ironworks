...
<!-- Platform adapter: Cline (.clinerules/ironworks.md) -->
...
Scaffold from zero to production-ready. Detects stack (16+ supported: Next.js, React, Vue, Angular, SvelteKit, Express, FastAPI, Django, Laravel, Go, Rust, Java/Spring, Scala, Elixir/Phoenix, .NET, Flutter), creates Cline rules, CONTEXT.md, .env.example, ironworks/specs/, docs/adr/, CI config, git init.
...
<!-- Install: Copy this file to .clinerules/ironworks.md in your project root. -->
